...
WiFiClient client;
byte server[] = { 
  10, 236, 80, 56 }; // http server - PUT HERE YOUR SERVER IP as bytes
String serverStr = "10.236.80.56"; // http server - PUT HERE YOUR SERVER IP as string
 ...
 Serial.println("Client started");
  ...
  if (client.connect(server, 80)) {  // http server is running on default port 80
   Serial.println("connected");
    client.print("GET /khalida/add.php?temp=");  // PUT HERE YOUR SERVER URL e.g. from http://192.168.1.11/SensorWriteToFile.php?temp=10.5&hum=58
